...
function App() {
  ...
  const handleLoginByEmail = (email: string, password: string) => {
    // TODO: 调用登录API校验email和password
    const userData: User = { email, name: 'Demo User' }
    handleLogin(userData)
  }

  const handleSignupByEmail = (email: string, password: string, name: string) => {
    // TODO: 调用注册API
